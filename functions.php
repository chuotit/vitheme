...
function vi_theme_scripts() {
	...
	wp_enqueue_style( 'jquery-ui-theme', get_template_directory_uri() . '/css/jquery-ui.theme.min.css');
	...
	wp_enqueue_style( 'vertical-menu', get_template_directory_uri() . '/css/vertical-menu.css');

	wp_enqueue_style( 'eweb-style', get_stylesheet_uri() );


	// Javascript ------------------------
	wp_enqueue_script( 'eweb-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );
	//wp_enqueue_script( 'modernizr', get_template_directory_uri() . '/js/modernizr.js', array( 'jquery' ), '2.6.1', true );
	wp_enqueue_script( 'eweb-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
	...
	wp_enqueue_script( 'dcverticalmegamenu', get_template_directory_uri() . '/js/jquery.dcverticalmegamenu.1.3.js', array(), '1.3', true );
	wp_enqueue_script( 'hoverIntent-minified', get_template_directory_uri() . '/js/jquery.hoverIntent.minified.js', array(), '', true );
